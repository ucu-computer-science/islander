...
void config_cgroup_subsystem(char subsystem[], char group_name[], char subsystem_filename[],
    ...
    char subsystem_path[MAX_PATH_LENGTH];
    ...
    char program_subsystem_path[MAX_PATH_LENGTH];
    ...
    char subsystem_file_path[MAX_PATH_LENGTH];
    ...
    char subsystem_tasks_path[MAX_PATH_LENGTH];
